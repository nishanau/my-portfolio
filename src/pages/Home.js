...
const projects = [
  ...
  },
  {
    ...
    description:
      "This is a full stack application built using Next.js. The app features user authentication with email, Google, and Facebook using NextAuth, and switches between dark mode and light mode based on the user's browser preferences. It includes product cards to display products and categories to filter the products. Tasks achieved include sign-up authentication, user profile management, and product display. Upcoming features include search functionality, user profile, adding products to cart and processing purchases, and adding skeletons for better UI.",
    url: "http://http://3.27.247.61:3000/", 
  },
  {
  ...
  },
  {
    ...
    description:
      "Created UI/UX design for a critical Bushfire Info & Management App, incorporating PACT (People, Activities, Context, Technologies) analysis. From low-fidelity to high-fidelity, I tailored the interface based on user personas and scenarios, ensuring an intuitive design for efficient bushfire information dissemination and management, aligning with PACT components. This project enhanced my skills in UI/UX design, user research, and prototyping.",
